...
function Home() {
    ...
    function loadDecks() {
        ...
        // call listDecks function and access the values of the decks that are loaded
    }
    ...
    const handleDelete = (deckId) => {
        ...
        if (confirmDeletion) { 
            // call the deleteDeck, load all of the decks, deckId used to access a specific deck you want to delete
    ...
    return (
        <div className="container">
            ...
            <div className="cards-in-deck" >
                {decks.map((deck) => {
                    return (
                        <div className="card" style={{ width: "55rem" }} key={deck.id}>
