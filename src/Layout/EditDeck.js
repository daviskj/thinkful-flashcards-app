...
export default function EditDeck() {
  ...
  function handleSubmit(deck) { 
    // go to the specified deck based off of result.id, access data from updateDeck
  ...
  useEffect(() => {
    ...
    // access data from readDeck function to get values of decks, change them with setDeck
  }, [deckId]);
      ...
      <nav aria-label="breadcrumb">
        <ol className="breadcrumb">
          <li className="breadcrumb-item">
            <Link to="/">
              <span className="oi oi-home"></span> Home</Link> {/*use span to access icons from bootstrap */}
          </li>
          <li className="breadcrumb-item">
